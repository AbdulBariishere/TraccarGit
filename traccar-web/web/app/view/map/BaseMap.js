    ...
    initMap: function () {
        ...
        switch (type) {
            ...
            case 'carto':
                layer = new ol.layer.Tile({
                    source: new ol.source.XYZ({
                         url: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>'
                ,
